...
var
  HTMLParser = require('../../../node_modules/html-minifier/dist/htmlminifier.js').HTMLParser;

module.exports = HtmlAngularFilter;

function HtmlAngularFilter(content, options) {
  this.options = options || {};
  this.setContent(content);
}

HtmlAngularFilter.prototype = {
