const
  ...
  DEFAULT_PHANTOM_MAX_CONTENT_LENGTH = 2097152,
...
function ImpressInstance(deferred, options) {
  ...
  this.impress = options.phantomScript || path.join(__dirname, '../../phantomjs/impress.js');
  this.invokeTimeout = options.phantomExecTimeout || DEFAULT_PHANTOM_EXEC_TIMEOUT;
  this.maxContentLength = options.phantomMaxContentLength || DEFAULT_PHANTOM_MAX_CONTENT_LENGTH;
